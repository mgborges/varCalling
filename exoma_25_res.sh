...
BATCH=exoma_25_res
THREADS=5
DATAPATH=/home/bioinf/exoma/exoma_25_res/raw
...
samples=`ls bams/*recal.bam | cut -f1 -d. | awk -F "bams/" '{print $2}' | sort | uniq`
...
parallel -j ${THREADS} picard_hsmetrics ::: $(ls bams/*.merged.bam.realn.bam) ::: qc/aln
