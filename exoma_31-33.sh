BATCH=exoma_31_32
THREADS=12
DATAPATH=/home/bioinf/exoma/exoma_31_32/raw
...
function haplotypecaller {
    ...
    perl $VEP -i ${VCF} -o ${VCF}.VEP.vcf --cache  --pubmed --sift b --polyphen b --ccds --uniprot --symbol --numbers --domains --regulatory --canonical --protein --biotype --gene_phenotype --gmaf --variant_class --vcf --port 3337 --force_overwrite --merged
}
...
parallel --xapply -j ${THREADS} mergegz ::: `ls`
